...
class Prop(DHRobot3D):
    ...
    def __init__(self, filename, env, is_stl=True, position=None, transform=None, color=None, force_unit=None, debug=False):
        ...
        print(position, transform) if self.debug else None
        self.add_to_env(env)
