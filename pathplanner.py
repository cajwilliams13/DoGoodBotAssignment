...
class PathPlanner:
    ...
    """
    def __init__(self, safe_z, reset_point=None, do_safe_z=True):
        self.reset_point = [250e-3, 100e-3, 500e-3] if reset_point is None else reset_point
...
def produce_path_plan(scene_file, save=None, show_matching=True, show_path=True, safe_z=0.2, brick_height_offset=40e-3):
    ...
    for target_index, brick_index in matched_pairs:
        head_offset = SE3.Rx(90, unit='deg')
...
if __name__ == "__main__":
    produce_path_plan("altscene.json", save='altplan.json')
